...
// POST route for sending email from portfolio contact form
  ...
  let mailOptions = {
    ...
    html: `
      <div style="background-color: #000000; padding: 20px; border-radius: 10px;">
        <h1 style="color: #4CAF50;">Contact Details</h1>
        ...
        <img src="cid:posterImage" alt="Thank You Image" style="width: 100%; max-width: 500px;" />
      </div>
    `
  };
...
// POST route for sending a thank-you email
app.post("/api/thankyouMail", async (req, res) => {
  ...
  let mailOptions = {
    ...
    html: `
      <div style="background-color: #000000; padding: 20px;">
        <h2 style="color: #ffffff;">Thank you for visiting my portfolio!</h2>
        <p style="color: #CECECE;">Your interest in my work is truly appreciated.</p>
        <img src="cid:posterImage" alt="Thank You Image" style="width: 100%; max-width: 500px;" />
      </div>
    `
  };
  ...
  try {
    ...
    res.status(200).send("Thank you email sent successfully");
  } catch (error) {
    console.error("Error sending thank you email:", error);
    res.status(500).send("Error sending thank you email");
  }
});
